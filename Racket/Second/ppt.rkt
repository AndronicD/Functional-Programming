...
(define get-nth-tuple
   (lambda (x)
     (lambda (y)
       (lambda (z)
         (apply-functional-transformations (x y '()) z)))))
...
(define get-nth-ppt-from-matrix-transformations
   (lambda (x) (((get-nth-tuple from-list-to-Tlist) (get-transformations x)) '(3 4 5))))
...
(define get-nth-quadruple
  (lambda (x) (((get-nth-tuple from-list-to-Qlist) (get-transformations x)) '(1 1 2 3))))
